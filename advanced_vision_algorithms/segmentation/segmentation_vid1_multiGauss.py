...
f = open('seq/office/temporalROI.txt','r')   # otwarcie pliku
...
bg = cv2.createBackgroundSubtractorMOG2(history=50, varThreshold = 120, detectShadows=False)
...
for i in range(i_start, i_end, i_step):
    ...
    fg = bg.apply(I, learningRate=0.0001)
